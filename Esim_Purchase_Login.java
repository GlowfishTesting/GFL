...
/**
 * Created by DELL on 22/11/2019.
 */
public class Esim_Purchase_Login {
...
System.out.println("Hello"+str8);
            ...
            if(str1!=""&&str2.equalsIgnoreCase("Glowfish QA A")&&str3.equalsIgnoreCase("glowfishtesting@gmail.com")&&str8.equalsIgnoreCase(str6)&&str10.contains("CAPTURE")&&str30.equalsIgnoreCase("COMPLETED")&&str220.equalsIgnoreCase("SOLD")&&str440.equalsIgnoreCase("Europe 1 GB")) {
                return true;
            }
            else
            {

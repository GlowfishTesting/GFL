...
/**
 * Created by DELL on 28/02/2020.
 */
public class Regional_Offer {
...
*/
            ...
            if(str1!=""&&str2.equalsIgnoreCase("ali")&&str3.equalsIgnoreCase("usman@glowfishlabs.com")&&str8.equalsIgnoreCase(str6)&&str10.contains("CAPTURE")&&str30.equalsIgnoreCase("COMPLETED")&&str220.equalsIgnoreCase("SOLD")&&str440.equalsIgnoreCase("Turkey 3 GB"))
